"""
Worker-9 — Custom Inspection Logic (바이브 코딩 가이드)
========================================================

[역할]
이 파일은 Worker-9의 커스텀 검사 로직을 정의합니다.
...
def process_frame(frame, cropped, *, detector, rejecter, data_manager, config):
    ...
    #     print(f"[Worker-9] 이전 신뢰도: {prev_confidence:.4f} → 현재 신뢰도: {curr_confidence:.4f} "
